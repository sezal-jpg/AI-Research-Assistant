...
[https://ai-frontend-286276858395.asia-south1.run.app/](https://ai-frontend-286276858395.asia-south1.run.app/)

## ⚙️ Backend API — FastAPI

[https://ai-backend-286276858395.asia-south1.run.app](https://ai-backend-286276858395.asia-south1.run.app)

## 📖 API Documentation

[https://ai-backend-286276858395.asia-south1.run.app/docs](https://ai-backend-286276858395.asia-south1.run.app/docs)
...
1. Ingests user-provided sources.
2. Processes and indexes the information.
3. Retrieves relevant evidence.
4. Combines semantic and lexical retrieval.
5. Reranks retrieved candidates.
6. Retrieves relevant graph relationships.
7. Builds hierarchical context.
8. Evaluates whether sufficient evidence exists.
9. Refines and retries when necessary.
10. Generates a grounded answer using Google Gemini.
